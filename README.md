![docker image](https://github.com/IMEM-CNR-Parma/NOMAD-Oasis-image/actions/workflows/docker-publish.yml/badge.svg)

# IMEM-CNR-Parma's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of IMEM-CNR-Parma. 
...
```sh
curl -L -o nomad-oasis.zip "https://github.com/IMEM-CNR-Parma/NOMAD-Oasis-image/raw/main/nomad-oasis.zip"
```
...
your `docker-compose.yaml` with `ghcr.io/IMEM-CNR-Parma/NOMAD-Oasis-image:main` for the services
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/IMEM-CNR-Parma/NOMAD-Oasis-image/manifests/main": unauthorized`
